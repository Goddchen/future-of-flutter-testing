...
class _FlutterDeckBulletListState extends State<FlutterDeckBulletList> {
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterDeckSlideStepsBuilder(
      builder: (BuildContext context, int stepNumber) => _BulletList(
        items: widget.items,
        autoSizeGroup: _autoSizeGroup,
        bulletPointWidget: widget.bulletPointWidget,
...
class _AutoSizeText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final FlutterDeckBulletListThemeData theme =
        FlutterDeckBulletListTheme.of(context);
    final TextStyle? textStyle = theme.textStyle;
